...
app.get("/candidates", function(req, res){ //controller needs to be modified
...
app.post("/candidates", function(req, res){
  Candidate.create(req.body.candidate).then(function(candidate){ //req.body requests info in body to request
